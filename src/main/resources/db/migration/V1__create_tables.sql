...
CREATE TABLE TB_USER_AUTH (
     ...
     DS_LOGIN_USER TEXT NOT NULL,
     DS_USER_ADDRESS_PROVIDER TEXT,
     ...
     ID_USER_PROVIDER UUID
);
CREATE INDEX INDEX_TB_USER_AUTH_TO_APPLICATION_ID ON TB_USER_AUTH (ID_APPLICATION,DS_LOGIN_USER);

CREATE TABLE TB_APPLICATION_DATA (
    ID_APPLICATION TEXT PRIMARY KEY,
    DS_APP_ADDRESS TEXT NOT NULL
);

CREATE TABLE TB_ACCESS_CONFIRM (
    ID_KEY UUID PRIMARY KEY,
    ID_USER_AUTH UUID NOT NULL,
    DT_HR_CREATED TIMESTAMP NOT NULL,
    DT_HR_CONFIRMED TIMESTAMP
);
